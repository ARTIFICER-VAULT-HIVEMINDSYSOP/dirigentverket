...
- The rider is a locomotive on ties and two rails. The body is deep green (`#2f5a45`) with brushed-steel plates, brass edges, and a V plate on the cab. NVDA green (`#76b900`) is the accent. It starts **FLAT** on the mid rail. The desk ground is gunmetal (`#101412`), panel faces are deep green, text is `#e9e3d6`, and rules are brass (`#a68446`).
