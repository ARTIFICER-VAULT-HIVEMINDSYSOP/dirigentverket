...
**14:35 Europe/Sofia 17 sep (ständig-process):** Magasin 8765 HTTP 200. PR #13 fortfarande draft CLEAN/MERGEABLE, 0 behind; mitt-pip engångs-puls när progress fade-out grind→proposed startar redan landat (`9ee7820`). Cloud follow-up: mjuk twin side-pip engångs-puls när samma fade-out grind→proposed startar (landing twin-tell, spegel till mitt-pip `9ee7820`; samma draft, ingen merge). PR #11 0 behind. PR #9 lamp = kväll. PII-fri backup `/workspace/backups/dirigentverket-verktyg-kod-20260917-1435.tar.gz`. Merge väntar namngivet ÖB-ja. No live/send/merge.
