...
## Redan i main (fa2384d)
Paper-arena, sticky PAPER-badge, kärna A–E, hopp, mallar, LIVE_LOCKED.

## Paper-bygge i PR #4 (draft — merge bara efter namngivet ja)
Branch `cursor/rider-kansla-32bit-0a6e`. Gate `hasCompletedFirstRide` / `RIDER_FIRST_RIDE_KEY`, «små belopp»-hint, impuls (process före fart), 32-bit playfeel (W/S/F/[ ]/Space), silhuett-HUD. Tester gröna enligt agent. Inte mergad.
